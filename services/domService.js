...
class DOMService {
    ...
    getElements() {
        return {
            ...
            forcedRollDateInput: document.getElementById("forced-roll-date"),
            forcedRollInput: document.getElementById("forced-roll-input"),
            scheduleForcedRollBtn: document.getElementById("schedule-forced-roll-btn"),
            clearForcedRollBtn: document.getElementById("clear-forced-roll-btn"),
            forcedRollStatus: document.getElementById("forced-roll-status"),
